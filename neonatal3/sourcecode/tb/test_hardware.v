...
module test_hardware();
    ...
    initial begin
        $readmemh("/home/users/yashb/neonatal3/sourcecode/tb/veeresh_compiler/build_output/hex/reciprocal_lut.hex",
                  _rec_rom);
    ...
    initial begin
        $readmemh("/home/users/yashb/neonatal3/sourcecode/tb/veeresh_compiler/veeresh_compiler.hex",
                  _cpu_rom);
    ...
    initial begin
        $readmemh("/home/users/yashb/neonatal3/sourcecode/tb/veeresh_compiler/build_output/hex/sigmoid_lut.hex",
                  _sig_rom);
    ...
    initial begin
        ...
        $readmemh("/home/users/yashb/neonatal3/sourcecode/tb/veeresh_compiler/build_output/golden/layer_9_dense_golden.hex", golden_layer2);
        $readmemh("/home/users/yashb/neonatal3/sourcecode/tb/veeresh_compiler/build_output/golden/layer_10_dense_golden.hex", golden_layer);
        $readmemh("/home/users/yashb/neonatal3/sourcecode/tb/veeresh_compiler/build_output/golden/layer_11_sigmoid_golden.hex", golden_sigmoid);
...
initial begin
    $readmemh("/home/users/yashb/neonatal3/sourcecode/tb/veeresh_compiler/build_output/hex/seizure_1.hex",      flash_input);
    $readmemh("/home/users/yashb/neonatal3/sourcecode/tb/veeresh_compiler/build_output/hex/global_weights.hex", flash_weight);
    $readmemh("/home/users/yashb/neonatal3/sourcecode/tb/veeresh_compiler/build_output/hex/global_bias.hex",    flash_bias);
    qspi_io_in = 4'b0;
end
